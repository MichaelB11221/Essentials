...
echo -- intel-dsa thorium nanazip bitdefenderavfree bulk-crap-uninstaller fxsound nilesoft-shell protonmail qbittorrent snappy-driver-installer windhawk wingetui autoruns nuget.commandline procmon vcredist140 eartrumpet ffmpeg k-litecodecpackbasic obs-studio vlc nodejs python3 visualstudio-installer
taskkill /f /im explorer.exe && start explorer.exe && start cmd /k "choco install intel-dsa thorium nanazip bitdefenderavfree bulk-crap-uninstaller fxsound nilesoft-shell protonmail qbittorrent snappy-driver-installer windhawk wingetui autoruns nuget.commandline procmon vcredist140 eartrumpet ffmpeg k-litecodecpackbasic obs-studio vlc nodejs python3 visualstudio-installer -y --force --ignorepackageexitcodes"
:: Pause the script
pause
